...
class ByteStreamer:
    def __init__(self, client: Client):
        ...
        This is a modified version of the <https://t.me/HDCINEMA_GROUP>
        Thanks to Eyaadh <https://t.me/HDCINEMA_GROUP>
        """
    ...
    async def yield_file(
        ...
        Modded from <https://t.me/HDCINEMA_1>
        Thanks to Eyaadh <https://t.me/HDCINEMA_1>
        """
        client = self.client
        work_loads[index] += 1
